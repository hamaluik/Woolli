...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Blazing Mammoth Games", "Woolli", "com.blazingmammothgames.woolli", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.blazingmammothgames.woolli.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.blazingmammothgames.woolli.Main, Reflect.field (com.blazingmammothgames.woolli.Main, "main"), []);
...
@:keep class DocumentClass extends com.blazingmammothgames.woolli.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Woolli", null, { width: 800, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.blazingmammothgames.woolli.Main, []);
			}
...
import com.blazingmammothgames.woolli.Main;
